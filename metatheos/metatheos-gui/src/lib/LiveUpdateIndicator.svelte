...
{#if $updateInProgress}
  <div class="fixed top-4 right-4 z-50" transition:fade={{ duration: 200 }}>
    <div class="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-lg shadow-lg">
...
{#if showRecentUpdate}
  ...
  >
    <div class="flex items-center gap-3 bg-green-500 text-white px-4 py-3 rounded-lg shadow-lg max-w-md">
