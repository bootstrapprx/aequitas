...
All authoritative specifications live in [`governance/canon/`](governance/canon/). This is the **Supreme Law** of the system.

- **[README.md](governance/canon/README.md)** - **Start Here:** The bridge between code and law.
- **[CANON_I](governance/canon/CANON_I_ACCOUNTING_TRUTH.md)** - Accounting Truth & Structure (What is real)
- **[CANON_II](governance/canon/CANON_II_AUTHORITY_AND_POWER.md)** - Authority & Power Boundaries (Who may act)
- **[CANON_III](governance/canon/CANON_III_EVOLUTION_AND_STATE.md)** - Evolution, State & Time (How things change)
- **[CANON_IV](governance/canon/CANON_IV_INTELLIGENCE_AND_GUIDANCE.md)** - Intelligence & Human Protection (Role of AI)

Also included are specific technical contracts:

- **[Kernel 2025.2](governance/canon/kernels/kernel_2025.2.md)** - Current implementation kernel

> **Note**: Additional protocol specifications may exist in `docs/canonical/` (legacy location). The authoritative Canon and Kernel documents are in `governance/canon/`.
...
**Read the full Constitution:** [governance/canon/README.md](governance/canon/README.md)
