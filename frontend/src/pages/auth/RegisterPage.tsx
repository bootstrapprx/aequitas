            ...
            <>
              <Button
                ...
                onClick={async () => {
                  try {
                    setIsLoading(true);
                    // The api client returns the response body directly
                    const response = await api.get<{ authorization_url: string }>('/auth/oauth/google/start');
                    ...
                    toast({
                      title: "Error",
                      description: "Could not initiate Google Sign Up",
                      variant: "destructive"
                    });
                    setIsLoading(false);
                  }
