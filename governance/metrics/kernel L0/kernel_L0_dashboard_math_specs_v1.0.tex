% !TeX root = ./kernel_L0_dashboard_math_specs_v1.0.tex
...
% Custom Commands
% =========================
\newcommand{\AccountSet}[1]{\mathcal{A}_{\text{#1}}}
\newcommand{\Balance}{B}
\newcommand{\Total}{T}
\newcommand{\Period}{p}
\newcommand{\Prior}{p^{-}}
...
% Scope Note
% =========================
% Note: This v1.0 specification covers a subset of the metrics defined in
% the full kernel_L0_dashboard_metrics_catalog.md (specifically Tier 1).
% Future versions will expand coverage to include Quick Ratio, Gross Margin, etc.
